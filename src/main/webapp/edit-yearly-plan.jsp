...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Edit Yearly Plan | Pulse Gym</title>
    <!-- Bootstrap 5 CSS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Google Fonts -->
...
<div class="container">
    <div class="card card-form">
        <h2><i class="fas fa-edit me-2"></i>Edit Yearly Plan</h2>
        <form action="yearlyPlanServlet" method="post" autocomplete="off">
            ...
            <div class="mb-3">
                <label for="addons" class="form-label">Add-ons (LKR)</label>
                <input type="number" class="form-control" id="addons" name="addons"
                       value="<%= request.getParameter("addons") %>" required min="0" step="0.01">
            </div>
            <div class="mb-3">
                <label for="subTotal" class="form-label">Sub Total (LKR)</label>
                <input type="number" class="form-control" id="subTotal" name="subTotal"
                       value="<%= request.getParameter("subTotal") %>" required min="0" step="0.01">
            </div>
            <div class="mb-3">
                <label for="discount" class="form-label">Discount (%)</label>
                <input type="number" class="form-control" id="discount" name="discount"
                       value="<%= request.getParameter("discount") %>" required min="0" max="100" step="0.01">
            </div>
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="finalPrice" name="finalPrice"
                       value="<%= request.getParameter("finalPrice") %>" required min="0" step="0.01">
            </div>
