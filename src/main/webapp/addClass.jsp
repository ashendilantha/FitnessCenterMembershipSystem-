...
<head>
    ...
    <title>Add New Class | Pulse Gym</title>
    <!-- Bootstrap 5 CSS -->
...
<div class="class-card">
    <h2><i class="fas fa-dumbbell me-2"></i>Add New Class</h2>
    ...
    <form method="post" action="AddClassServlet" autocomplete="off">
        <div class="row g-3">
            <div class="col-md-6">
                <div class="mb-3">
            ...
            <div class="col-12">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="radio-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="classType" id="groupType" value="Yoga">
                                <label class="form-check-label" for="groupType">Yoga Class</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="classType" id="personalType" value="WeightTraining">
                ...
                <div class="col-12 d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-pulse"><i class="fas fa-plus me-2"></i>Add Class</button>
                </div>
            </div>
        </div>
    </form>
