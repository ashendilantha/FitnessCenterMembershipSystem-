...
<head>
  ...
  <title>Class Schedule | Pulse Gym</title>
  <!-- Bootstrap 5 CSS -->
...
<div class="schedule-container" aria-labelledby="schedule-heading">
  <h2 class="schedule-header" id="schedule-heading">Class Schedule</h2>
  <p class="text-center mb-4 text-muted">Browse our fitness classes and find the perfect session for your training needs.</p>
  ...
  <%
    ...
    if (classes.isEmpty()) {
  %>
  <div class="alert alert-warning text-center">No classes found</div>
  <%
  } else {
