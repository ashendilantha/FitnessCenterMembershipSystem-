...
<div class="plans-card" aria-labelledby="yearly-plans-heading">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4">
        <h2 id="yearly-plans-heading" class="mb-3 mb-md-0"><i class="fas fa-list icon"></i>Yearly Plans</h2>
        <a href="add-yearly-plan.jsp" class="btn btn-success" aria-label="Add New Yearly Plan">
